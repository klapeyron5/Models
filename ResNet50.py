...
class Model_ResNet50:
    ...
    def __init__(self,input_size=224,input_depth=3,output_depth=2,model_name='ResNet50'):
    ...
    def get_graph(self,mode,exploit_params):
        ...
        with graph.as_default():
            ...
            res_block = Model_constructor.residual_block_large
            id = [0]
            ...
            if Model_constructor.get__MODE() == Model_constructor.cons__MODE_train():
                if self.optimizer == Model_ResNet50.const__optimizers_list()[0]:
                    optimizer = tf.train.RMSPropOptimizer(self.learning_rate)
                elif self.optimizer == Model_ResNet50.const__optimizers_list()[1]:
    ...
    def set__optimizer(self, params_dict):
        ...
        assert self.optimizer in Model_ResNet50.const__optimizers_list()
